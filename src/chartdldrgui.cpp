...
ChartDldrPanel::ChartDldrPanel( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	m_dpChartDirectory = new wxDirPickerCtrl( this, wxID_ANY, wxT("/home/nohal"), _("Select a folder"), wxDefaultPosition, wxDefaultSize, wxDIRP_DEFAULT_STYLE|wxDIRP_USE_TEXTCTRL );
	fgSizer1->Add( m_dpChartDirectory, 0, wxALL|wxEXPAND, 5 );
	...
	m_dpChartDirectory->Connect( wxEVT_COMMAND_DIRPICKER_CHANGED, wxFileDirPickerEventHandler( ChartDldrPanel::OnLocalDirChanged ), NULL, this );
...
{
	// Disconnect Events
	m_cbChartSources->Disconnect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( ChartDldrPanel::OnSourceSelected ), NULL, this );
	m_dpChartDirectory->Disconnect( wxEVT_COMMAND_DIRPICKER_CHANGED, wxFileDirPickerEventHandler( ChartDldrPanel::OnLocalDirChanged ), NULL, this );
